...
evaluate.py
===========
KKT residual evaluation and optimality metrics for Iteration 4.1.
"""
...
def evaluate_solution(
    ...
    # 2. Dual Objective (max -h^T lambda)
