...
run_iteration_1.py
==================
Main demonstration script for KKT_Solver_Iteration_1.
...
Solves:
  ...
  4. Netlib Benchmark (benchmarks/input/afiro.mps)
...
from KKT_Solver_Iteration_1 import solve_kkt_instance, compare_kinn_vs_highs


def run_demonstration():
    print("=" * 70)
    print("🧠 KKT_SOLVER_ITERATION_1: SINGLE-INSTANCE KINN SOLVER RUNNER")
    print("=" * 70)
    ...
    test_files = [
        ...
        os.path.join(project_root, "benchmarks", "input", "afiro.mps")
    ]
    ...
    for filepath in test_files:
        ...
        # For diet & supply chain, Adam with 1500-2500 epochs finds good convergence
    ...
    print("\n" + "=" * 80)
    print("🏆 CONSOLIDATED KINN ITERATION 1 RESULTS TABLE")
    print("=" * 80)
