...
model.py
========
Decoupled Neural Architecture for KKT_Solver_Iteration_5.

Stage 1 Neural Scout Architecture:
- Fully Decoupled Networks: Primal and Dual branches have completely separate
  hidden representations to eliminate gradient cross-talk.
- GELU activations to preserve gradient flow across smooth manifolds.
- Anti-Saturation Dual Head: Linear bias initialized to +1.0 so dual multipliers
